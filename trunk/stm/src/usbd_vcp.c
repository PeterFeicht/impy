...
/**
 * DeInitialize the VCP interface.
 * 
 * @param  pdev device instance
 * @param  cfgidx Configuration index (unused, VCP only has one configuration)
 * @retval {@code USBD_Status} code
...
/**
 * Handle the VCP specific requests.
 * 
 * @param  pdev instance
